        ...
        <div className="flex-shrink-0 border-t border-white/10 p-3 space-y-1">
          ...
          {user?.isAdmin && onAdminClick && (
            <button
              ...
              className={`w-full flex items-center ${isCollapsed ? 'lg:justify-center' : 'justify-start'} px-4 py-3 rounded-lg transition-all group mb-1 text-white hover:bg-white/5`}
