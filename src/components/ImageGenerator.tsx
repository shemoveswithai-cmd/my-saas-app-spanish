    ...
    return (
        <div className="flex flex-col h-full bg-rosa-claro rounded-lg shadow-xl p-4 md:p-6 space-y-4 overflow-y-auto">
            <div className="bg-white rounded-[1.5rem] shadow-sm p-5 md:p-6 text-center mb-6 border border-rosa-principal/5 max-w-3xl mx-auto">
                <h1 className="text-xl md:text-2xl font-bold text-negro-fondo mb-2 uppercase tracking-tight">Generación de Imágenes de Calidad de Estudio</h1>
            ...
            <div className="bg-white/60 backdrop-blur-sm shadow-md p-4 rounded-lg flex flex-col md:flex-row gap-4 flex-shrink-0">
                <div className="flex-1 flex flex-col gap-2">
                    <textarea
                        ...
                        className="w-full bg-white/50 border-2 border-rosa-principal/50 rounded-lg p-3 focus:ring-2 focus:ring-rosa-principal focus:outline-none resize-none h-24 text-negro-fondo placeholder:text-negro-fondo/70"
                        disabled={isLoading}
                    />
                     <input
                        type="text"
                        ...
                        className="w-full bg-white/50 border-2 border-rosa-principal/30 rounded-lg p-2 focus:ring-2 focus:ring-rosa-principal focus:outline-none text-negro-fondo placeholder:text-negro-fondo/60 text-sm"
                        disabled={isLoading}
                    />
                </div>
                <div className="flex flex-col gap-4 w-full md:w-48">
                    <select
                        ...
                        className="w-full bg-white/50 border-2 border-rosa-principal/50 rounded-lg p-3 focus:ring-2 focus:ring-rosa-principal focus:outline-none text-negro-fondo disabled:bg-white/30 disabled:text-negro-fondo/70 disabled:cursor-not-allowed"
                        disabled={isLoading}
                    >
                    ...
                    <button
                        ...
                        className="w-full bg-rosa-principal text-negro-fondo font-bold py-3 px-4 rounded-lg flex items-center justify-center hover:bg-white disabled:bg-rosa-principal/50 disabled:cursor-not-allowed"
                    >
            ...
            <div className="bg-white/60 backdrop-blur-sm shadow-md p-4 rounded-lg flex-shrink-0">
                <label className="block text-sm font-medium text-negro-fondo mb-1">Parecido (Opcional)</label>
                <p className="text-sm text-negro-fondo opacity-90 mb-2">Para crear imágenes de una persona específica, sube una foto de referencia.</p>
                {referenceImagePreview ? (
                    <div className="relative w-24 h-24">
                        <img src={referenceImagePreview} alt="Referencia" className="w-full h-full object-cover rounded-md border border-rosa-principal/20" />
                        <button 
                    ...
                    <button 
                        ...
                        disabled={isLoading}
                        className="w-full md:w-1/2 bg-white/50 border-2 border-rosa-principal/50 rounded-lg p-2 focus:ring-2 focus:ring-rosa-principal focus:outline-none text-negro-fondo hover:bg-white/80 transition-all"
                    >
            ...
            {error && <div className="p-4 bg-red-900 text-blanco-texto rounded-md flex-shrink-0">{error}</div>}
            ...
            <div className="flex-1 flex items-center justify-center bg-white/60 backdrop-blur-sm shadow-md rounded-lg p-4 min-h-[400px]">
                {isLoading ? (
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-negro-fondo opacity-80 font-bold animate-pulse">Generando tu obra maestra...</p>
                    </div>
                ) : generatedImage ? (
                    <div className="relative group max-h-full">
                        ...
                        <a
                            ...
                            className="absolute bottom-4 right-4 bg-negro-fondo bg-opacity-60 hover:bg-opacity-80 text-white p-3 rounded-full transition-all duration-300 shadow-xl backdrop-blur-sm"
                        >
                    ...
                    <p className="text-negro-fondo opacity-80 italic">Tu imagen generada aparecerá aquí.</p>
                )}
            </div>
            ...
            <div className="space-y-6 pt-10 border-t border-rosa-principal/20 flex-shrink-0">
                ...
                <div className="bg-white/60 backdrop-blur-sm shadow-md p-8 rounded-lg border border-white/40">
                    <h2 className="text-2xl font-bold text-negro-fondo mb-6 text-center">Consejos de Venta y Monetización</h2>
